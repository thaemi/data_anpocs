...
st.write("O data.(Anpocs) é um projeto que visa o armazenamento dos trabalhos apresentados nosEncontros Anuais da Anpocs(Associação Nacional de Pós-Graduação em Ciências Sociais poreixos temáticos organizando-os e facilitando o amplo acesso ao conhecimento produzido e apresentado nas edições dos Encontros anteriores")
