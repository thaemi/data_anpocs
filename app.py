...
st.write("O data.(Anpocs) é um projeto que visa o armazenamento dos trabalhos apresentados nos  Encontros Anuais da Anpocs(Associação Nacional de Pós-Graduação em Ciências Sociais por ")
st.write("eixos temáticos organizando-os e facilitando o amplo acesso ao conhecimento produzido e apresentado nas edições dos Encontros anteriores.")
